...
<%
	if (BaseServlet.isAdmin(request)) {
		...
		out.println("  <li class=\"path\"><a href=\"repository_export.jsp\">存储导出</a></li>");
		out.println("</ul>");
		out.println("<br/>");
		out.println("<form action=\"repository_export.jsp\">");
		out.println("<table class=\"form\" align=\"center\">");
		out.println("<tr>");
		out.println("<td>存储路径</td>");
		out.println("<td><input type=\"text\" size=\"50\" name=\"repoPath\" id=\"repoPath\" value=\""+repoPath+"\" ></td>");
		out.println("<td><a class=\"ds\" href=\"../extension/DataBrowser?action=repo&sel=fld&dst=repoPath&root="+Config.INSTANCE_CHROOT_PATH+"\"><img src=\"img/action/browse_repo.png\"/></a></td>");
		out.println("</tr>");
		out.println("<tr>");
		out.println("<td>文件路径</td>");
		out.println("<td><input type=\"text\" size=\"50\" name=\"fsPath\" id=\"fsPath\" value=\""+fsPath+"\" ></td>");
		out.println("<td><a class=\"ds\" href=\"../extension/DataBrowser?action=fs&sel=fld&dst=fsPath\"><img src=\"img/action/browse_fs.png\"/></a></td>");
		out.println("</tr>");
		out.println("<tr><td>源数据</td><td><input type=\"checkbox\" name=\"metadata\" "+(metadata?"checked":"")+"/></td></tr>");
		out.println("<tr><td>历史版本</td><td><input type=\"checkbox\" name=\"history\" "+(history?"checked":"")+"/></td></tr>");
